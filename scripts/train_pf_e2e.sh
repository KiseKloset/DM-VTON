python train_pf_e2e.py --project runs/train/PFAFN_align_mobile_clean-viton --name PFAFN_PF_e2e_align_mobile_100 \
...
--pf_warp_checkpoint 'runs/train/PFAFN_align_mobile_clean-viton/PFAFN_PF_warp_align_mobile_100/weights/pf_warp_last.pt' 