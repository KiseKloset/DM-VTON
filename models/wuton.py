...
if __name__=='__main__':
	thetaGeneratorAffine = GenerateTheta(geometric_model="affine").to(DEVICE)
	thetaGeneratorTPS = GenerateTheta(geometric_model="tps", tps_grid_size=3).to(DEVICE)

	geo_tnf_affine = GeometricTransformer(geometric_model="affine").to(DEVICE)
	geo_tnf_tps = GeometricTransformer(geometric_model="tps", tps_grid_size=3).to(DEVICE)
