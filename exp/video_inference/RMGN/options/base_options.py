...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--hr', action='store_true', help='if specified, test high resolution')
        self.parser.add_argument('--load_hr_author', action='store_true', help='if load high resolution, test high resolution with author supp models')
