...
class TpsGridGen(nn.Module):
    def __init__(
        self, out_h=224, out_w=224, use_regular_grid=True, grid_size=3, reg_factor=0, use_cuda=True
    ):
        super().__init__()
...
class WUTON(nn.Module):
    ...
    def forward(self, gan_product_image_batch, model_agnostic_image_batch):
        theta_affine = self.thetaGeneratorAffine(
            gan_product_image_batch, model_agnostic_image_batch
        )
